...
/*   Updated: 2025/01/13 17:34:50 by lilefebv         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_cam_proj(t_env *env, t_camera *camera)
{
	...
	{
		camera->proj_x = camera->x + camera->distance * cos(camera->yaw) * cos(camera->pitch);				
		camera->proj_y = camera->y + camera->distance * cos(camera->yaw) * sin(camera->pitch);
		camera->proj_z = camera->z + camera->distance * sin(camera->yaw);
	}
	else
	{
